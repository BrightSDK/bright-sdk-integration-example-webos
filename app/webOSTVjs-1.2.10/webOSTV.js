                ...
                : !0 === P.dolbyAtmosConfig
                  ...
                  : !1 === P.dolbyAtmosConfig
                    ? 'tv_speaker_external_arc_harmony' === P.soundOutput
                        ...
                        : void 0 === P.soundOutput
                          ? (console.log('[webOSTV.js] soundOutput value is', P.soundOutput), B(e))
                          : z(!1, e)
            ...
            new v().send({
                ...
                onComplete: function (t) {
                    if (t.configs) {
                        ...
                        ((T.sdkVersion = t.configs['tv.nyx.platformVersion'] || T.sdkVersion),
                            (T.uhd =
                            ...
                            (T.dolbyVision = !0 === t.configs['tv.config.supportDolbyHDRContents']),
